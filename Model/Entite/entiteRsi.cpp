...
// Définition des méthodes de la classe Rsi
//-----------------------------------------------------------
...
void Rsi::setReseaux(float reseaux)
{
    ...
    {
        MessageBox(NULL, "La note Réseaux doit être comprise entre 0 et 20.", "Erreur", MB_ICONERROR | MB_OK);
    }
}
//-----------------------------------------------------------
void Rsi::setCommutation(float commutation)
{
    ...
    {
        MessageBox(NULL, "La note Commutation doit être comprise entre 0 et 20.", "Erreur", MB_ICONERROR | MB_OK);
    }
}
//-----------------------------------------------------------
int Rsi::getId()
